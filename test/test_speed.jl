...
warn_memory(bytes, 200000, "Neo Separable_ExogStates: Solver")
...
warn_memory(bytes, 220000000, "Neo All: Simulator")
...
warn_memory(bytes, 250000000, "Neo Separable: Simulator")

simulate(sol_neoclassical_Separable_States, shocks)
val, t, bytes = @timed simulate(sol_neoclassical_Separable_States, shocks)
warn_time(t, 0.28, "Neo Separable_States: Simulator")
warn_memory(bytes, 250000000, "Neo Separable_States: Simulator")
...
diopt = Dict(
	...
	:rewardcall=>:pre, :initialize_exact=>false)

sol_int_All = solve(p_int_All; diopt...)
val, t, bytes = @timed solve(p_int_All; diopt...)
warn_time(t, 2., "Intangible All: Solver")
warn_memory(bytes, 800000000, "Intangible All: Solver")
...
warn_memory(bytes, 550000, "Intangible Separable_ExogStates: Solver")
...
warn_time(t, 0.26, "Int All: Simulator")
warn_memory(bytes, 56000000, "Int All: Simulator")

simulate(sol_int_Sep, shocks)
val, t, bytes = @timed simulate(sol_int_Sep, shocks)
warn_time(t, 0.27, "Int Separable: Simulator")
warn_memory(bytes, 62000000, "Int Separable: Simulator")

simulate(sol_int_Sep_States, shocks)
val, t, bytes = @timed simulate(sol_int_Sep_States, shocks)
warn_time(t, 0.27, "Int Separable_States: Simulator")
warn_memory(bytes, 62000000, "Int Separable_States: Simulator")

simulate(sol_int_Sep_ExogStates, shocks)
val, t, bytes = @timed simulate(sol_int_Sep_ExogStates, shocks)
warn_time(t, 0.28, "Int Separable_ExogStates: Simulator")
warn_memory(bytes, 62000000, "Int Separable_ExogStates: Simulator")
